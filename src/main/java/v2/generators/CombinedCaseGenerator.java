...
public abstract class CombinedCaseGenerator<T> extends Generator<T> {
    private List<T> cornerCases;
    private int iterator;
    private Class<T> type;
    private InstantiatorNormal instantiatorNormal;
    private InstantiatorCornerCase instantiatorCornerCase;
    ...
    private void initializeOrNothing(){
        if(this.instantiatorCornerCase == null){
            this.instantiatorCornerCase = new SimpleCornerCaseInstantiator();
        }
